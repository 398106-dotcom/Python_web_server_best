# SetUp_3_pyw.py — installer & updater (pyw_mode)
import pathlib, urllib.request, base64, json, subprocess, sys, os

# -----------------------
SERVER_URL = "https://raw.githubusercontent.com/398106-dotcom/Python_web_server_best/refs/heads/main/pyw_mode/start_server.pyw"
...
def main():
    ...
    server_path = folder / "start_server.pyw"
    print("⬇️ Updating start_server.pyw...")
    try:
        ...
        print("✅ start_server.pyw updated successfully!")
    except Exception as e:
        print("❌ Failed to update start_server.pyw:", e)
        sys.exit(1)
...
# -----------------------
def main():
    print("=== Python Web Server Installer / Updater (pyw_mode) ===\n")
    ...
    # ---- download start_server.pyw ----
    server_path = folder / "start_server.pyw"
    if server_path.exists():
        print("⚠️ start_server.pyw exists — updating...")
    ...
    print(f"👉 Run: {server_path} to start server (double-click works!)")
    print(f"👉 Run: python \"{folder / 'update.py'}\" to update start_server.pyw anytime")
